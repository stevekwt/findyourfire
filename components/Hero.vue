<template>
    <div class="Hero container">
        <div class="text-container">
            ...
            <p>Fiery foundings: an extraordinarily luscious string with unique and piquant words which when summoned will blossom forth atop the veritable crown of listings. And you know they'll fight fire with fire. That's fiery foundlings.</p>
        </div>
